%% JUlie's Function from SoundAnalysisBats for spectrogram

function [to, fo, logB, pg, tError, fError] = HumanBat_Julie_Spec_Only_Bats_onefig(sound_in, samprate, DBNOISE, f_high, fband, varargin)
